...
add_page_info( 'title', 'دفع الراتب' );
add_page_info( 'nav', array('name'=>'المدفوعات', 'url'=>get_site_url('admin/payment')) );
add_page_info( 'nav', array('name'=>'دفع الراتب') );
?>
...
<ul class="nav nav-tabs" role="tablist"> 
	<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><i class="fa fa-file-text-o"></i> النموذج</a></li> 
	<?php if($payment->id): ?>
		<li role="presentation" class="dropdown pull-right"> <a href="#" class="dropdown-toggle" id="myTabDrop1" data-toggle="dropdown" aria-controls="myTabDrop1-contents" aria-expanded="false"><i class="fa fa-cogs"></i> خيارات <span class="caret"></span></a> 
			<ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents"> 
				<li><a href="#dropdown1" role="tab" id="dropdown1-tab" data-toggle="tab" aria-controls="dropdown1"><i class="fa fa-tasks fa-fw"></i> تعيين المهمة</a></li> 
				<li><a href="<?php site_url('admin/user/message/add.php?attachment&payment_id='.$payment->id); ?>"><i class="fa fa-envelope-o fa-fw"></i> إضافة مرفق الرسالة</a></li>
		...
		<?php if($payment->id): ?><li class="pull-right"><a href="print.php?id=<?php echo $payment->id; ?>&print" target="_blank"><i class="fa fa-print"></i> طباعة</a></li><?php endif; ?>
	<?php endif; ?>
</ul>
	...
	<div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab"> 
		...
		<form name="form_payment" id="form_payment" action="" method="POST">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<div class="form-group">
						<label for="account_code"><i class="fa fa-barcode"></i> رمز الحساب </label>
				...
				<div class="col-md-2">
					<div class="form-group">
						<label for="account_name">اسم الموظفين اسم العائلة <?php if(@$payment->account_id):?><a href="../account/detail.php?id=<?php echo $payment->account_id; ?>" target="_blank"><i class="fa fa-external-link"></i></a><?php endif; ?> </label>
				...
				<div class="col-md-2">
					<div class="form-group">
						<label for="account_tax_no">رقم الهوية </label>
				...
				<div class="col-md-2">
					<div class="form-group">
						<label for="account_email">البريد الاكتروني </label>
