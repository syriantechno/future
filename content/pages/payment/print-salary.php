...
<title>الراتب / استلام مسبق</title>
<div class="print-page" size="A4">
	...
	<div class="row">
		<div class="col-xs-6">
			<h4 class="content-title">الراتب / استلام مسبق</h4>
		</div> <!-- /.col-md-* -->
		<div class="col-xs-6">
	...
	<div class="print-footer print-footer-left">
		<small class="text-muted"><img src="<?php site_url('content/themes/default/img/logo_header.png'); ?>" class="img-responsive pull-left" width="64"> معتمدة من برنامج المستقبل!</small>
	</div>
</div>
