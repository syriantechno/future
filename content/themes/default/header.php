...
<html lang="en">
  <head>
    ...
    <script src="<?php echo template_url('js/jquery-ui.js'); ?>" integrity="sha256-lFA8dPmfmR4AQorTbla7C2W0aborhztLt0IQFLAVBTQ=" crossorigin="anonymous"></script>
        ...
        <ul class="nav navbar-nav navbar-right">
        	        ...
        	        <a href="<?php echo $message->message; ?>">
        	          <div class="row no-space">
        	            ...
        	            <div class="col-md-10">
        	              ...
        	              <span class="message-time"><i class="fa fa-clock-o"></i> <?php echo get_time_late($message->date_update); ?> منذ</span>
          ...
          <li class="icon-badge dropdown">
            ...
            <ul class="dropdown-menu dropdown-message-list effect-1">
              ...
              <?php endif; ?>
              <li class="message-footer"><a href="<?php site_url('admin/user/task/list.php'); ?>">جميع المهام</a></li>
            </ul>
          </li>
          <!-- /task -->
          ...
          <li class="icon-badge dropdown">
            ...
            <ul class="dropdown-menu dropdown-message-list effect-1">
              ...
              <?php endif; ?>
              <li class="message-footer"><a href="<?php site_url('admin/user/message/list.php'); ?>">جميع المشاركات</a></li>
            </ul>
          </li>
          <!-- /message -->
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle profile-avatar" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              ...
              <span class="user-name"><?php active_user('username'); ?> <span class="user-role"><?php echo get_user_role_text(get_active_user('role')); ?></span></span>
            </a>

            <ul class="dropdown-menu">
              <li><a href="<?php site_url('admin/user/profile.php'); ?>"><i class="fa fa-meh-o"></i>ملفي الشخصي</a></li>
              <li><a href="<?php site_url('admin/user/change_password.php'); ?>"><i class="fa fa-key"></i> تغيير كلمة المرور</a></li>
              <li role="separator" class="divider"></li>
              <li><a href="<?php site_url('logout.php'); ?>"><i class="fa fa-power-off"></i> تسجيل خروج</a></li>
            </ul>
          </li><!--/ .dropdown /-->
