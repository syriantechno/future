$(document).ready( function() {
	...
	$('.dataTable').DataTable({
		...
		"language": {
	        ...
	        "sZeroRecords":   "لم يتم العثور على سجلات السجل وفقا لنتائج البحث.",
	        ...
	        "sInfoPostFix":   "",
	        "sSearch":        "",
	        "searchPlaceholder": "...اكتب ماتريد البحث عنه هنا",
	        "sUrl":           "",
	        "sInfoThousands":  ",",
	        "sDom": 'rt',
	        ...
	        "oAria": {
	            "sSortAscending":  ": تنشيط لترتيب العمود تصاعدي",
	            "sSortDescending": ": قم بتنشيط لترتيب العمود بترتيب تنازلي"
	        }
	    }
	});
	...
	$(".datetime").datetimepicker({
        ...
        tooltips: {
		    ...
		    prevDecade: 'العقد الحالي',
		    nextDecade: 'العقد السابق',
