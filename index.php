...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="row space-5">
            <?php if(user_access('admin')): ?><div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class="box-menu">
                    ...
                    <div>
                        <div class="list-group mobile-full list-group-dashboard" style="width: 100%;">
                            <?php foreach($form_status_all as $key => $status): ?>
                                <a href="admin/form/list.php?status_id=<?php echo $status->id; ?>" class="list-group-item-column" style="border-left:25px solid <?php echo $status->bg_color; ?>; width: 50%">
                                    <?php echo $status->name; ?>
                                    <?php if($status->is_default == 'default'): ?><small class="text-muted">(افتراضي)</small><?php endif; ?>
						...
						<?php while($list = $query->fetch_object()): ?>
							...
							<tr class="pointer" onclick="location.href='<?php site_url('form', $list->id); ?>';">
                                ...
                                if($list->type=='form') {
                                    ...
                                    if($list->in_out == '0') { echo 'دفعة منه'; } else { echo 'دفعة له'; }
                                }
                                ?>
                                </td>
							</tr>
				...
				<div class="panel panel-warning panel-border-0">
					...
					<div class="panel-body">
						...
						<div class="row space-5">
							...
							<div class="col-md-8">
								<div class="">
									<small class="text-muted" style="color:#1f1d1d;"><?php echo $total['item']['i']; ?></small> <small class="text-muted">مواد مختلفة</small>
									<br />
									<span class="ff-2 fs-18 bold"><?php echo $total['item']['quantity']; ?></span> <small class="text-muted">العدد</small>
									<div class="h-10"></div>
							...
							<div class="col-md-6">
								<div class="">
									...
									<br />
<!--									<span class="ff-2 fs-14 bold">--><?php //echo get_set_money($total['item']['purc']); ?><!--</span> <small class="text-muted">--><?php //echo til()->company->currency; ?><!--</small>-->
								</div>
							</div>
							<div class="col-md-6">
								<div class="">
...
<!--									<span class="ff-2 fs-14 bold">--><?php //echo get_set_money($total['item']['sale']); ?><!--</span> <small class="text-muted">--><?php //echo til()->company->currency; ?><!--</small>-->
								</div>
							</div>
						</div>
				...
				<div class="panel panel-success panel-border-0">
					...
					<div class="panel-body">
						...
						<div class="row space-5">
							...
							<div class="col-md-8">
								<div class="">
									<small class="text-muted" style="color:#1f1d1d;">الصافي</small> <small class="text-muted">مجموع</small>
									<br />
									<span class="ff-2 fs-18 bold"><?php echo get_set_money($total['case']); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
									<div clas="h-20"></div>
							...
							<div class="col-md-6">
								<div class="">
									...
									<br />
									<span class="ff-2 fs-14 bold">+ <?php echo get_set_money( db()->query("SELECT sum(total) as total FROM ".dbname('forms')." WHERE in_out='0' AND status='1' AND type='payment' AND date >= '".date('Y-m-d')." 00:00:00' AND date <= '".date('Y-m-d')." 23:59:59' ")->fetch_object()->total ); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
								</div>
							</div>
							<div class="col-md-6">
								<div class="">
									...
									<br />
									<span class="ff-2 fs-14 bold">- <?php echo get_set_money( db()->query("SELECT sum(total) as total FROM ".dbname('forms')." WHERE in_out='1' AND status='1' AND type='payment' AND date >= '".date('Y-m-d')." 00:00:00' AND date <= '".date('Y-m-d')." 23:59:59' ")->fetch_object()->total ); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
								</div>
							</div>
						</div>
