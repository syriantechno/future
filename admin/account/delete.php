           ...
           <div class="panel panel-default panel-table">
               ...
               <div class="btn-group btn-icon hidden-xs" data-toggle="tooltip" data-placement="top" title="طباعة">
                 ...
                 <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     <li><a href="<?php echo str_replace('list.php', 'exportexl.php', get_set_url_parameters(array('add'=> array('export'=>'printexl')))); ?>" target="_blank">طباعة استمارة للكل </a></li>
                     <li><a href="<?php echo str_replace('list.php', 'exportexl.php', get_set_url_parameters(array('add'=> array('export'=>'printexl', 'limit'=>'false')))); ?>" target="_blank">طباعة استمارة نشطة <sup class="text-muted">(<?php echo $accounts->num_rows; ?>)</sup></a></li>
                     <li class="divider"></li>
...
<div class="panel panel-default panel-table">
	<div class="panel-heading hidden-xs">
		<div class="row">
			<div class="col-xs-6 col-md-6">
				<h3 class="panel-title">بطاقات المستفيد</h3>
			</div>
