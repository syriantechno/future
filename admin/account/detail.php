...
<?php endif; ?>
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item"><a href="#logs" role="tab" id="logs-tab" data-toggle="tab" aria-controls="logs"
                                aria-selected="false"><i class="fa fa-database"></i><span class="hidden-xs"> سجل العمليات</span></a>
        </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-md-4">
                                        <div class="form-group country_selected">
                                            ...
                                            <select type="text" name="living" id="living" value="<?php echo @$_POST['living']; ?>"
