	...
	<div class="panel-heading hidden-xs">
		...
		<div class="row">
			...
			<div class="col-xs-6 col-md-6" style="display: flex">
				...
				<h3 class="panel-title" style="padding-left: 20px;">بطاقات المستفيد</h3>
                <form action="<?= $_SERVER['PHP_SELF']; ?>" method="get" class="form-inline">
                    <div class="form-group">
                        ...
                        ?>
                        <input type="text" name="from_date" class="form-control input-sm date" placeholder="من" value="<?= $from_date; ?>" style="width: 20%;">
                        <input type="text" name="to_date" class="form-control input-sm date" placeholder="إلى" value="<?= $to_date; ?>" style="width: 20%;">

                        <button class="btn" type="submit" style="    height: 29px;    text-align: center;    padding: 4px;border-radius: 2px; margin-right: 10px;">
                            <i class="fa fa-search text-black"></i><span style="color: #4c4c4c">بحث بتاريخ الميلاد</span>
                        </button>
                        <button class="btn" type="submit" style="    height: 29px;    text-align: center;    padding: 4px; border-radius: 2px;">
                            <a href="<?php site_url('admin/account/list.php'); ?>">  <i class="fa fa-arrow-circle-left text-black"></i> عودة </a>
                        </button>
                    </div>
                    ...
                    <div class="pull-right">
                        <div class="btn-group btn-icon hidden-xs" data-toggle="tooltip" data-placement="top" title="Pdf">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'pdf')))); ?>">تصدير قائمة نشطة</a></li>
                                <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'pdf', 'limit'=>'false')))); ?>">تصدير الكل <sup class="text-muted">(<?php echo $accounts->num_rows; ?>)</sup></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="btn-group btn-icon hidden-xs" data-toggle="tooltip" data-placement="top" title="Excel">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'excel')))); ?>">تصدير قائمة نشطة</a></li>
                                <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'excel', 'limit'=>'false')))); ?>">تصدير الكل <sup class="text-muted">(<?php echo $accounts->num_rows; ?>)</sup></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="btn-group btn-icon hidden-xs" data-toggle="tooltip" data-placement="top" title="طباعة">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'print')))); ?>" target="_blank">طباعة القائمة النشطة</a></li>
                                <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'print', 'limit'=>'false')))); ?>" target="_blank">طباعة الكل <sup class="text-muted">(<?php echo $accounts->num_rows; ?>)</sup></a></li>
                                <li><a href="<?php echo str_replace('list.php', 'exportexl.php', get_set_url_parameters(array('add'=> array('export'=>'printexl')))); ?>" target="_blank">طباعة استمارة نشطة </a></li>
                                <li><a href="<?php echo str_replace('list.php', 'exportexl.php', get_set_url_parameters(array('add'=> array('export'=>'printexl', 'limit'=>'false')))); ?>" target="_blank">طباعة استمارة للكل <sup class="text-muted">(<?php echo $accounts->num_rows; ?>)</sup></a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters( array('add'=> array('export'=>'print', 'addBarcode'=>true )) )); ?>" target="_blank">طباعة قائمة الركود النشطة</a></li>
                                <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters( array('add'=> array('export'=>'print', 'limit'=>'false', 'addBarcode'=>true)) )); ?>" target="_blank">طباعة كافة البراكودات <sup class="text-muted">(<?php echo $accounts->num_rows; ?>)</sup></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <?php foreach($accounts->list as $account): ?>
				...
				<tr id="account-id-<?= $account->id; ?>">
                    ...
                    <td >
                        ...
                        <input class="box" type="checkbox" name="checkbox" data-toggle="check-table-row" data-target="#account-id-<?= $account->id; ?>" id="check-<?= $account->id; ?>"/>
                    </td>
