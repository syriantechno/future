	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<div class="row space-none">
			<div class="col-md-4">
				...
				<div class="well">
					<span class="ff-2 fs-18 bold <?php echo $total['status'] < 0 ? 'text-danger' : 'text-success'; ?>"><?php echo get_set_money($total['status']); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
					<br />
					...
					<?php if($query->num_rows): ?>
                        <table class="table table-hover table-condensed table-stripe">
                            ...
                            <?php while($list = $query->fetch_object()): ?>
                                <tr onclick="location.href='<?php site_url('account', $list->id); ?>#forms';" class="pointer">
                                    <td><a href="<?php site_url('account', $list->id); ?>#forms" title="<?php echo $list->name; ?>"><?php echo til_get_substr($list->name,0,30); ?></a></td>
							...
							<tbody>
								<?php while($list = $query->fetch_object()): ?>
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <a href="../form/detail.php?id=<?php echo $list->id; ?>" target="_blank">#<?php echo $list->id; ?></a>
                                        <?php } ?>
                                    </td>
                                    ...
                                    <td>
										...
										<td><a href="<?php site_url('account', $list->account_id); ?>#forms" title="<?php echo $list->account_name; ?>"><?php echo til_get_substr($list->account_name,0,30); ?></a></td>
									<tr>
									</tr>
								<?php endwhile; ?>
							</tbody>
