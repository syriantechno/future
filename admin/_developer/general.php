                ...
                <div class="panel-body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-default btn-xs" data-toggle="tooltip"
                                        data-placement="left" title="Tooltip on left"><i class="fa fa-arrow-left"></i>
                                    Tooltip on left
                                </button>
                            </td>
                        </tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-default btn-xs" data-toggle="tooltip"
                                        data-placement="right" title="Tooltip on right"><i
                                            class="fa fa-arrow-right"></i> Tooltip on right
                                </button>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-default btn-xs" data-toggle="tooltip"
                                        data-placement="top" title="Tooltip on top"><i class="fa fa-arrow-up"></i>
                                    Tooltip on top
                                </button>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-default btn-xs" data-toggle="tooltip"
                                        data-placement="bottom" title="Tooltip on bottom"><i
                                            class="fa fa-arrow-down"></i> Tooltip on bottom
                                </button>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="panel-body">
                    <table class="table">
                        <tr>
                            ...
                            <td width="50%">
                                <button type="button" class="btn btn-default btn-xs" data-container="body"
                                        data-toggle="popover" data-trigger="focus" title="This is a title"
                            ...
                            <td>
                                <button type="button" class="btn btn-default btn-xs" data-container="body"
                                        ...
                                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><i
                                            class="fa fa-arrow-left"></i> Popover on left
                                </button>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-default btn-xs" data-container="body"
                                        ...
                                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><i
                                            class="fa fa-arrow-right"></i> Popover on right
                                </button>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-default btn-xs" data-container="body"
                                        ...
                                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><i
                                            class="fa fa-arrow-up"></i> Popover on top
                                </button>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-default btn-xs" data-container="body"
                                        ...
                                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><i
                                            class="fa fa-arrow-down"></i> Popover on bottom
                                </button>
                            </td>
                        </tr>
                    </table>
