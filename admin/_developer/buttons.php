        ...
        <div class="col-md-6">
            <div class="panel panel-default ">
                ...
                <div class="panel-body _get_example">
                    ...
                    <!--del-->
                    <p><code>&lt;a&gt;</code>, <code>&lt;input&gt;</code>, <code>&lt;button&gt;</code> elementlerinden
                        herhangi birinde kullanabilirsiniz.</p>
                    <!--/del-->
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body _get_example">
                    ...
                    <!--del-->
                    <p><code>.btn-outline</code> ile birlikte <code>.btn-rounded</code> sınıfını ekleyerek bu görünüme
                        ulaşabilirsiniz.</p>
                    <!--/del-->
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!--del--><p><code>&lt;i class="fa"&gt;</code> nesnesini ekleyerek istediğiniz icon görünümlerini
                        ekleyebilrisiniz. Tüm icon listesini görmek için "<a href="#" class="bold">buraya</a>"
                        tıklayınız.</p><!--/del-->
                    ...
                    <div class="_get_example _get_example_div">
                        ...
                        <a href="#" class="btn btn-warning"><i class="fa fa-exclamation-triangle fa-btn"></i>
                            warning</a>
                    ...
                    <!--del-->
                    <div class="h-20"></div><!--/del-->
                    <!--del--><p>Yukarıdaki örnek ile birlikte <code>.btn-icon</code> sınıfını ekleyek bu görünüme
                        ulaşabilirsiniz.</p><!--/del-->
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default panel-heading-0">
                ...
                <div class="panel-body">
                    ...
                    <!--del--><p><code>.btn-group</code> örnekleri ile gruplandırılmış butonlar elde edebilirsiniz.</p>
                    <!--/del-->
                    <div class="_get_example _get_example_div">
                    ...
                    <!--del-->
                    <div class="h-20"></div><!--/del-->
                    <!--del--><p><code>.btn-icon</code> ve <code>.btn-outline</code> gibi sınıflarıda kullanabilirsiniz.
                    </p><!--/del-->
                    <div class="_get_example _get_example_div">
                        <div class="btn-group" role="group" aria-label="...">
                            <button type="button" class="btn btn-danger"><i class="fa fa-trash-o"></i> Danger</button>
                            <button type="button" class="btn btn-warning btn-icon"><i class="fa fa-warning"></i> Warning
                            </button>
                            <button type="button" class="btn btn-success btn-outline">Success</button>
                            <button type="button" class="btn btn-primary btn-outline"><i class="fa fa-rocket"></i>
                                Primary
                            </button>
                            <button type="button" class="btn btn-info">Info</button>
                        </div>
            ...
            <div class="panel panel-default panel-heading-o">
                ...
                <div class="panel-body">
                    ...
                    <div class="_get_example _get_example_div">
                        ...
                        <!--del-->
                        <div class="btn-group">
                            <button type="button" class="btn btn-warning btn-outline dropdown-toggle"
                        ...
                        <!--del-->
                        <div class="btn-group">
                            <button type="button" class="btn btn-danger btn-icon dropdown-toggle" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                    ...
                    <!--del-->
                    <div class="h-20"></div><!--/del-->
                    <!--del--><p>Aşağı doğru açılan menülerde sadece ok işaretine tıklanırsa menü açılsın.</p>
                    <!--/del-->
                    <div class="_get_example _get_example_div">
                        ...
                        <!--del-->
                        <div class="btn-group">
                            <button type="button" class="btn btn-danger btn-icon"><i class="fa fa-trash-o"></i> Action
                            </button>
