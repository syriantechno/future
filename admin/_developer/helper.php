                ...
                <div class="panel-body">
                    <table class="table">
                        <tr>
                            ...
                            <td width="50%">
                                <div class="bg-muted p-5">Example text</div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.bg-success</code></td>
                            <td>
                                <div class="bg-success p-5">Example text</div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.bg-warning</code></td>
                            <td>
                                <div class="bg-warning p-5">Example text</div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.bg-danger</code></td>
                            <td>
                                <div class="bg-danger p-5">Example text</div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.bg-primary</code></td>
                            <td>
                                <div class="bg-primary p-5">Example text</div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.bg-info</code></td>
                            <td>
                                <div class="bg-info p-5">Example text</div>
                            </td>
                        </tr>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <small>
                                ...
                                <br/>
                                Bu sınıfta, <b>1</b></code>'den başlayarak <b>10</b>'a kadar bir degerlerini
                                yazabilirsiniz.
                            </small>
                        </div> <!-- /.col-md-6 -->
                    </div>
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td width="50%">
                                <div class="bg-info p-10 b-0" style="border-color:#fb6f6f !important;">Example text
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.b-1</code></td>
                            <td>
                                <div class="bg-info p-10 b-1" style="border-color:#fb6f6f !important;">Example text
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.b-5</code></td>
                            <td>
                                <div class="bg-info p-10 b-5" style="border-color:#fb6f6f !important;">Example text
                                </div>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <small>
                                <code>*int</code> sayısal bir değer ifade eder.
                                <br/>
                                Bu sınıfta, <b>1</b></code>'den başlayarak <b>10</b>'a kadar ve <b>50</b> ve <b>100</b>
                                degerlerini yazabilirsiniz.
                            </small>
                        </div> <!-- /.col-md-6 -->
                    </div>
                    <div class="h-20"></div>
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td width="50%">
                                <div class="bg-success p-10 br-0">Example text</div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.br-5</code></td>
                            <td>
                                <div class="bg-success p-10 br-5">Example text</div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.br-10</code></td>
                            <td>
                                <div class="bg-success p-10 br-10">Example text</div>
                            </td>
                        </tr>
                    </table>
                </div> <!-- /.panel-body -->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <small>
                                <code>*int</code> sayısal bir değer ifade eder.
                                <br/>
                                <b>1</b></code>'den başlayarak <b>20</b>'ye kadar ve <b>50</b> ve <b>100</b> degerlerini
                                yazabilirsiniz.
                            </small>
                        </div> <!-- /.col-md-6 -->
                    </div>
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td width="50%">
                                <div class="bg-warning p-0">Example text</div>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="panel-body">
                    <table class="table">
                        <tr>
                            ...
                            <td width="50%">
                                <div><img src="<?php site_url(get_active_user('avatar')); ?>" class="img-32"></div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.img-64</code></td>
                            <td>
                                <div><img src="<?php site_url(get_active_user('avatar')); ?>" class="img-64"></div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.img-128</code></td>
                            <td>
                                <div><img src="<?php site_url(get_active_user('avatar')); ?>" class="img-128"></div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.img-64</code> <code>.br-10</code></td>
                            <td>
                                <div><img src="<?php site_url(get_active_user('avatar')); ?>" class="img-64 br-10">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div><img src="<?php site_url(get_active_user('avatar')); ?>" class="img-64 img-circle">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div><img src="<?php site_url(get_active_user('avatar')); ?>"
                                          class="img-64 img-thumbnail"></div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div><img src="<?php site_url(get_active_user('avatar')); ?>"
                                          class="img-64 img-thumbnail img-circle"></div>
                            </td>
                        </tr>
                    </table>
                </div> <!-- /.panel-body -->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <small>
                                <code>*int</code> sayısal bir değer ifade eder.
                                <br/>
                                Bu sınıfta, <b>1</b></code>'den başlayarak <b>20</b>'ye ve <b>10</b>, <b>20</b>,
                                <b>30</b>, <b>40</b>, <b>50</b>, <b>60</b>, <b>70</b>, <b>80</b>, <b>90</b>, <b>100</b>
                                arasında herhangi bir degerlerini yazabilirsiniz.
                            </small>
                        </div> <!-- /.col-md-6 -->
                    </div>
                    <div class="h-20"></div>
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td width="50%">
                                <div class="bg-info h-10"></div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.h-30</code></td>
                            <td>
                                <div class="bg-info h-30"></div>
                            </td>
                        </tr>
                        <tr>
                            <td><code>.h-50</code></td>
                            <td>
                                <div class="bg-info h-50"></div>
                            </td>
                        </tr>
                    </table>
                </div> <!-- /.panel-body -->
