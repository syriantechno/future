...
<?php include('_header.php'); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h3 class="panel-title">تنبيه</h3></div>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h3 class="panel-title">تنبيه مع العنوان</h3></div>
                <div class="panel-body _get_example">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h3 class="panel-title">تنبيه مع رفض</h3></div>
                <div class="panel-body _get_example">
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h3 class="panel-title">تنبيه مع زر</h3></div>
                <div class="panel-body _get_example">
                    ...
                    <div class="alert alert-info">
                        ...
                        <p class="text-right">
                            ...
                            <button type="button" class="btn btn-default o">Or do this</button>
                        </p>
                    </div>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <p><strong>Info!</strong> Indicates a neutral informative change or action.</p>
                        <p>
                            <button type="button" class="btn btn-danger btn-outline btn-rounded">Take this action
                            </button>
                        </p>
                    </div>
