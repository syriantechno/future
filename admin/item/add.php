...
<div class="row">
	<div class="col-md-6">
		...
		<div class="row">
			...
			<div class="col-xs-6 col-md-5">
				<div class="form-group">
					...
					<input type="text" pattern="[0-9]+([\.,][0-9]+)?" name="p_purc_out_vat" id="p_purc_out_vat" value="" class="form-control money" maxlength="15" disabled>
				</div> <!-- /.form-group -->
			</div> <!-- /.col-md-5 -->
			<div class="col-xs-6 col-md-5">
				<div class="form-group">
					<label for="p_sale_out_vat">سعر البيع <sup class="text-muted"><u>بإستثناء الضريبة</u></sup></label>
					<input type="text" pattern="[0-9]+([\.,][0-9]+)?" name="p_sale_out_vat" id="p_sale_out_vat" value="" class="form-control money" maxlength="11" disabled>
				</div> <!-- /.form-group -->
			</div> <!-- /.col-md-5 -->
		</div> <!-- /.row -->
		...
		<div class="row">
			<div class="col-xs-6 col-md-2">
				<div class="form-group">
					...
					<input type="tel"  pattern="[0-9]+([\.,][0-9]+)?" name="vat" id="vat" value="<?php echo @$_POST['vat']; ?>" class="form-control digits" maxlength="2" onkeyup="calc_vat();" onfocusout="calc_vat();">
				</div> <!-- /.form-group -->
			</div> <!-- /.col -->
			...
			<div class="col-xs-6 col-md-5">
				<div class="form-group">
					...
					<input type="number" pattern="[0-9]+([\.,][0-9]+)?" name="p_purc" id="p_purc" value="<?php echo @$_POST['p_purc']; ?>" class="form-control money" onkeyup="calc_vat();" onfocusout="calc_vat();">
				</div> <!-- /.form-group -->
			</div> <!-- /.col -->
			<div class="col-xs-6 col-md-5">
				<div class="form-group">
					<label for="p_sale">سعر البيع</label>
					<input type="number" pattern="[0-9]+([\.,][0-9]+)?" name="p_sale" id="p_sale" value="<?php echo @$_POST['p_sale']; ?>" class="form-control money"  onkeyup="calc_vat();" onfocusout="calc_vat();" >
				</div> <!-- /.form-group -->
			</div> <!-- /.col -->
		</div> <!-- /.row -->
		...
		<div class="h-20"></div>
		<div class="form-group">
			<label class="veritical-center"><input type="checkbox" name="again" id="again" value="1" <?php if(isset($_POST['again']) or isset($_GET['again'])): ?>checked<?php endif; ?> data-toggle="switch" switch-size="sm" on-text="نعم" off-text="لا"> &nbsp; هل ستقوم باضافة مادة جديدة بعد التسجيل</label>
		</div> <!-- /.form-group -->
		...
		<div class="text-right">
			...
			<button class="btn btn-success btn-xs-block btn-insert"><i class="fa fa-plus-square"></i> حفظ</button>
		</div>
