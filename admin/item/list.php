				...
				<div class="pull-right">
					...
					<div class="btn-group btn-icon" data-toggle="tooltip" data-placement="top" title="Pdf">
					  ...
					  <ul class="dropdown-menu dropdown-menu-right">
					    ...
					    <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'pdf', 'limit'=>'false')))); ?>">تصدير الكل <sup class="text-muted">(<?php echo $items->num_rows; ?>)</sup></a></li>
					  </ul>
					</div>
					...
					<div class="btn-group btn-icon" data-toggle="tooltip" data-placement="top" title="Excel">
					  ...
					  <ul class="dropdown-menu dropdown-menu-right">
					    ...
					    <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'excel', 'limit'=>'false')))); ?>">تصدير الكل <sup class="text-muted">(<?php echo $items->num_rows; ?>)</sup></a></li>
					  </ul>
					</div>
					...
					<div class="btn-group btn-icon" data-toggle="tooltip" data-placement="top" title="طباعة">
					  ...
					  <ul class="dropdown-menu dropdown-menu-right">
					    ...
					    <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'print', 'limit'=>'false')))); ?>" target="_blank">طباعة الكل <sup class="text-muted">(<?php echo $items->num_rows; ?>)</sup></a></li>
					    <li class="divider"></li>
					    ...
					    <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters( array('add'=> array('export'=>'print', 'limit'=>'false', 'addBarcode'=>true)) )); ?>" target="_blank">طباعة قائمة الباركود<sup class="text-muted">(<?php echo $items->num_rows; ?>)</sup></a></li>
					  </ul>
					</div>
