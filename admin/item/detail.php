...
<ul class="nav nav-pills mb-3" role="tablist">
	<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><i class="fa fa-id-card-o"></i><span class="hidden-xs"> بطاقة المعونة</span></a></li>
	<li role="presentation" class=""><a href="#forms" role="tab" id="forms-tab" data-toggle="tab" aria-controls="forms" aria-expanded="false"><i class="fa fa-list"></i><span class="hidden-xs"> كشف حركات المعونة</span></a></li>
	<li role="presentation" class=""><a href="#logs" role="tab" id="logs-tab" data-toggle="tab" aria-controls="logs" aria-expanded="false"><i class="fa fa-database"></i><span class="hidden-xs"> سجل العمليات</span></a></li> 
	...
	<li role="presentation" class="dropdown pull-right til-menu-right"> <a href="#" class="dropdown-toggle" id="myTabDrop1" data-toggle="dropdown" aria-controls="myTabDrop1-contents" aria-expanded="false"><i class="fa fa-cogs"></i><span class="hidden-xs"> خيارات </span><span class="caret"></span></a> 
		<ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents"> 
			<li><a href="<?php site_url('admin/user/task/add.php?attachment&item_id='.$item->id); ?>" target="_blank"><i class="fa fa-tasks fa-fw"></i> إلحاق المهمة</a></li> 
			<li><a href="<?php site_url('admin/user/message/add.php?attachment&item_id='.$item->id); ?>" target="_blank"><i class="fa fa-envelope-o fa-fw"></i> إضافة مرفق الرسالة</a></li> 
			<li role="separator" class="divider"></li>
			<?php if($item->status == '1'): ?>
				<li><a href="#"  data-toggle="modal" data-target="#status_item"><i class="fa fa-trash-o fa-fw text-danger"></i> حذف</a></li>
			<?php else: ?>
				<li><a href="?id=<?php echo $item->id; ?>&status=1"><i class="fa fa-undo fa-fw text-success"></i> نشط</a></li>
			<?php endif; ?>
		</ul> 
	</li>
	...
	<li role="presentation" class="dropdown pull-right til-menu-right"> <a href="#" class="dropdown-toggle" id="myTabDrop1" data-toggle="dropdown" aria-controls="myTabDrop1-contents" aria-expanded="false"><i class="fa fa-print"></i><span class="hidden-xs"> طباعة </span><span class="caret"></span></a> 
		<ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents"> 
			<li><a href="print-statement.php?id=<?php echo $item->id; ?>&print" target="_blank"><i class="fa fa-fw fa-file-text-o"></i> طباعة البيان</a></li>
			<li class="divider"></li>
			<li><a href="print-barcode.php?id=<?php echo $item->id; ?>&print" target="_blank"><i class="fa fa-fw fa-barcode"></i> طباعة الباركود</a></li>
			<li><a href="print-barcode_price.php?id=<?php echo $item->id; ?>&print" target="_blank"><i class="fa fa-fw fa-barcode"></i> طباعة باركود الاسعار</a></li>
		</ul> 
	</li>
</ul>
				...
				<form name="form_add_accout" id="form_add_account" action="" method="POST" class="validate">
					...
					<div class="row">
						...
						<div class="col-xs-6 col-md-5">
							<div class="form-group">
								<label for="p_purc_out_vat">سعر التكلفة <sup class="text-muted"><u>بإستثناء الضريبة</u></sup></label>
								<input type="text"  pattern="[0-9]+([\.,][0-9]+)?" name="p_purc_out_vat" id="p_purc_out_vat" value="<?php echo get_set_money($item->p_purc_out_vat); ?>" class="form-control money" maxlength="15" disabled>
							</div> <!-- /.form-group -->
						</div> <!-- /.col -->
						<div class="col-xs-6 col-md-5">
							<div class="form-group">
								<label for="p_sale_out_vat">سعر البيع <sup class="text-muted"><u>بإستثناء الضريبة</u></sup></label>
								<input type="text"  pattern="[0-9]+([\.,][0-9]+)?" name="p_sale_out_vat" id="p_sale_out_vat" value="<?php echo get_set_money($item->p_sale_out_vat); ?>" class="form-control money" maxlength="11" disabled>
							</div> <!-- /.form-group -->
						</div> <!-- /.col-md-5 -->
					</div> <!-- /.row -->
					...
					<div class="row">
						...
						<div class="col-xs-6 col-md-5">
							<div class="form-group">
								...
								<input type="number"  name="p_purc" id="p_purc" value="<?php echo get_set_money($item->p_purc); ?>" class="form-control money" maxlength="15" onkeyup="calc_vat();" onfocusout="calc_vat();">
							</div> <!-- /.form-group -->
						</div> <!-- /.col -->
						<div class="col-xs-6 col-md-5">
							<div class="form-group">
								<label for="p_sale">سعر البيع</label>
								<input type="number"  name="p_sale" id="p_sale" value="<?php echo get_set_money($item->p_sale); ?>" class="form-control money" maxlength="15" onkeyup="calc_vat();" onfocusout="calc_vat();">
							</div> <!-- /.form-group -->
						</div> <!-- /.col -->
					</div> <!-- /.row -->
					...
					<div class="text-right">
						...
						<button class="btn btn-success btn-xs-block btn-insert"><i class="fa fa-floppy-o"></i> حفظ</button>
					</div>
				</form>
			</div> <!-- /.col-* -->
			<div class="col-md-6">
...
مرات
					...
					<div class="col-xs-6 col-md-4">
						<div class="">
							<span class="ff-2 fs-17 bold"><?php echo get_set_money($item->quantity * $item->p_purc); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
							<br>
					...
					<div class="col-xs-6 col-md-4">
						<div class="">
							<span class="ff-2 fs-15 bold"><?php echo get_set_money($item->quantity * $item->p_sale); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
							<br>
				...
				<div class="row">
					<div class="col-xs-4 col-md-4">
						<div class="">
							<span class="ff-2 fs-15 bold"><?php echo get_set_money($item->total_purc); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
							<br>
					...
					<div class="col-xs-4 col-md-4">
						<div class="">
							<span class="ff-2 fs-15 bold"><?php echo get_set_money($item->total_sale); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
							<br>
					...
					<div class="col-xs-4 col-md-4">
						<div class="">
							<span class="ff-2 fs-15 bold <?php echo $item->profit > 0 ? 'text-success' : 'text-danger'; ?>"><?php echo get_set_money($item->profit); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
							<br>
		...
		<div class="row">
			<div class="col-md-4">
				...
				<div class="h-20 visible-xs"></div>
				<small class="text-muted module-title-small"><i class="fa fa-users"></i> الزبائن الأكثر تفضيلا</small>
				<div class="h-10"></div>
			...
			<div class="col-md-8">
				...
				<div class="h-20 visible-xs"></div>
				<small class="text-muted module-title-small"><i class="fa fa-th-list"></i> آخر التحركات من هذا المنتج</small>
				<div class="h-10"></div>
									...
									<tbody>
										<?php while($list = $query->fetch_object()): ?>
											...
											<tr onclick="location.href='<?php site_url('form', $list->form_id); ?>';" class="pointer">
												...
												<td class="text-right" width="100"><?php echo get_set_money($list->price); ?> <small class="text-muted"><?php echo til()->company->currency; ?></small></td>
												<td class="text-right" width="100"><?php echo get_set_money($list->total); ?> <small class="text-muted"><?php echo til()->company->currency; ?></small></td>
											</tr>
										<?php endwhile; ?>
									</tbody>
								</table>
					...
					<?php while($list = $q_form_items->fetch_object()): ?>
						...
						<?php else: ?>
							...
							<tr id="<?php echo $list->id; ?>">
								...
								<td>
									<?php if($list->account_id): ?>
										<?php echo get_account($list->account_id)->name; ?> <a href="<?php site_url('account', $list->account_id); ?>#formws" target="_blank" class="fs-12"><i class="fa fa-external-link"></i></a>
									<?php endif; ?>
                                <td class="text-right"><?php echo get_set_money($list->price, true); ?></td>
								</td>
                                <td class="text-right"><?php if($list->in_out == 0) { echo get_set_money($list->quantity, true); $balance = $balance + $list->quantity; } else { echo ''; } ?></td>
                                <td class="text-right"><?php if($list->in_out == 1) { echo get_set_money($list->quantity, true); $balance = $balance - $list->quantity; } else { echo ''; } ?></td>
