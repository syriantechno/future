...
?>
  ...
  <ul class="nav nav-pills mb-3" role="tablist">
    <li role="presentation" class="active"><a href="#team" onclick="document.title='المبرمجون | ultra'" id="team-tab" aria-controls="team" role="tab" data-toggle="tab" aria-expanded="false">المبرمجون</a></li>
    <li role="presentation" class=""><a href="#terms-of-use" onclick="document.title='شروط الاستخدام | ultra'" id="terms-of-use-tab" aria-controls="terms-of-use" role="tab" data-toggle="tab" aria-expanded="false">شروط الاستخدام</a></li>
  </ul>
  ...
  <div class="tab-content">
            ...
            <div class="developer-area">
              ...
              <div class="info-area">
                ...
                <ul class="nav navbar-nav sociail-nav">
                  <li><a href="https://www.facebook.com/louai.alshaaer" class="facebook" data-wenk="facebook"><i class="fa fa-facebook"></i></a></li>
                  <li><a href=" https://wa.me/0096176404750" class="whatsapp" data-wenk="whatsapp"><i class="fa fa-whatsapp"></i></a></li>
    ...
    <div role="tabpanel" class="tab-pane" id="terms-of-use" aria-labelledby="terms-of-use-tab">
     <p>  البرنامج خاضع لاتفاقية البرامج المفتوحة المصدر GNU General Public License لايجوز بيعه او نقله تحت اي ظرف او اي شكل من الاشكال</p>
      <p>لاتقم بتعديل السورس كود ابدا اتصل بالمبرمج واطلب منه التعديل المناسب / قد يتسبب التعديل من قبلك باتلاف البيانات</p>  <!--/ Terms Of Use /-->
