...
<div class="row">
				...
				<div class="box-menu">
					<a href="<?php site_url('admin/payment/detail.php?out'); ?>">
						<span class="icon-box4">
                            ...
                            <i class="faw fa-minus-square-o" style="color: rgba(255, 255, 255, 0.4117647058823529);"></i>
                            <hr>
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="well">
					<span class="ff-2 fs-18 bold <?php echo $total['money'] < 0 ? 'text-danger' : 'text-success'; ?>"><?php echo get_set_money($total['money']); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
					<br />
