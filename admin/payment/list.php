			...
			<div class="col-md-6" style="display: flex;">
                ...
                <form action="<?= $_SERVER['PHP_SELF']; ?>" method="get" class="form-inline">
                    <div class="form-group">
                        <input type="text" name="from_date" class="form-control input-sm date" placeholder="من" value="" style="width: 20%;">
                        <input type="text" name="to_date" class="form-control input-sm date" placeholder="إلى" value="" style="width: 20%;">
		...
		<table class="table table-hover table-bordered table-condensed table-striped">
			<thead>
				<tr>
					...
					<th width="100" class="hidden-xs">مقبوضات<?php echo get_table_order_by('account_gsm', 'ASC'); ?></th>
					<th width="100" class="hidden-xs">مدفوعات<?php echo get_table_order_by('account_city', 'ASC'); ?></th>
