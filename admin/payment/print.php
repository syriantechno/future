...
<?php if(isset($_GET['id'])): ?>
	<?php if(!$payment = get_payment($_GET['id'])) { exit('لم يتم العثور على شكل المطلوب.'); } ?>
...
<?php $form_meta = get_form_meta($payment->id); ?>
	...
	<?php
	if($payment->in_out == '0') { $print['title'] = 'سند قبض'; } else { $print['title'] = 'سند صرف'; }
	...
	<div class="row">
		<div class="col-xs-6">
			...
			<?php if($payment->in_out == 1): ?>
				<div class="fs-10 text-muted"> المسلم - <small>الاسم والشهرة والامضاء</small></div>
			<?php else: ?>
				<div class="fs-10 text-muted"> المستلم - <small>الاسم والشهرة والامضاء</small></div>
			<?php endif; ?>
			<div class="h-10"></div>
