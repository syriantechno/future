...
} else { add_page_info( 'nav', array('name'=>'الصندوق والبنك', 'url'=>get_site_url('admin/payment')) ); }
...
<?php if($cases or $banks): // هل لديك صندوك او بنك? ?>
    ...
    if(isset($_GET['account_id'])) {
        ...
        } else { add_alert('لم يتم العثور على بطاقة الحساب.', 'warning'); }
    }
    ?>
    ...
    <ul class="nav nav-tabs til-nav-page" role="tablist">
        <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><i class="fa fa-file-text-o"></i><span class="hidden-xs">نموذج السند</span></a></li>
        <?php if($payment->id): ?>
            ...
            <li role="presentation" class="dropdown pull-right til-menu-right"><a href="#" class="dropdown-toggle" id="myTabDrop1" data-toggle="dropdown" aria-controls="myTabDrop1-contents" aria-expanded="false"><i class="fa fa-cogs"></i><span class="hidden-xs">خيارات </span><span class="caret"></span></a>
                <ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                    <li><a href="<?php site_url('admin/user/task/add.php?attachment&payment_id='.$payment->id); ?>" target="_blank"><i class="fa fa-tasks fa-fw"></i> إلحاق المهمة</a></li>
                    <li><a href="<?php site_url('admin/user/message/add.php?attachment&payment_id='.$payment->id); ?>" target="_blank"><i class="fa fa-envelope-o fa-fw"></i> إضافة مرفق الرسالة</a></li>
                    <li role="separator" class="divider"></li>
                    <?php if($payment->status == '1'): ?>
                        <li><a href="#" data-toggle="modal" data-target="#status_item"><i class="fa fa-trash-o fa-fw text-danger"></i> حذف</a></li>
                    <?php else: ?>
                        <li><a href="?id=<?php echo $payment->id; ?>&status=1"><i class="fa fa-undo fa-fw text-success"></i> نشط</a></li>
                    <?php endif; ?>
                </ul>
            </li>
            <li class="dropdown pull-right til-menu-right"><a href="print.php?id=<?php echo $payment->id; ?>&print" target="_blank" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-print"></i><span class="hidden-xs"> طباعة </span><span class="caret"></span></a>
                <ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                    <li><a href="print.php?id=<?php echo $payment->id; ?>&print" target="_blank"><i class="fa fa-print fa-fw"></i> طباعة </a></li>
                    <li><a href="print.php?id=<?php echo $payment->id; ?>" target="_blank"><i class="fa fa-file-o fa-fw"></i> معاينة الطباعة </a></li>
                </ul>
            </li>
        <?php endif; ?>
    </ul>
            ...
            <div class="col-xs-6 col-md-2 hidden-xs">
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        // إذا كان رمز حساب إيغر يتغير، يكون account_id الذي يبقى في الإدخال الخفي صفر.
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="cheq_number" id="cheq_number" class="form-control text-right money" value="<?php echo @$payment->cheq_number; ?>">
                        </div> <!-- /.form-group -->
                    </div> <!-- /.col-* -->
                    <div class="col-xs-6 col-md-2">
                        <div class="form-group">
                            <label for="cheq_date">تاريخ الاستحقاق</label>
                            <input type="text" name="cheq_date" id="cheq_date" class="form-control input-sm date" value="<?php echo @substr($payment->cheq_date,0,10); ?>" >
                        </div> <!-- /.form-group -->
                    </div> <!-- /.col-* -->
                        <div class="col-xs-6 col-md-2">
                            <div class="form-group">
                                <label for="bank_name">اسم البنك</label>
                                <input type="text" name="bank_name" id="bank_name" class="form-control input-sm" value="<?php echo @$payment->bank_name; ?>">
                            </div> <!-- /.form-group -->
                        </div> <!-- /.col-* -->
                    </div>
                ...
                <div class="text-right">
                    ...
                    <button class="btn btn-success btn-icon">
                        <i class="fa fa-floppy-o"></i>     حــــفــــظ  </button>
