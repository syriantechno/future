...
<ul class="nav nav-tabs til-nav-page" role="tablist">
    <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><i class="fa fa-file-text-o"></i><span class="hidden-xs"> نموذج</span></a></li>
    <?php if($form->id): ?>
        <li role="presentation" class=""><a href="#logs" role="tab" id="logs-tab" data-toggle="tab" aria-controls="logs" aria-expanded="false"><i class="fa fa-database"></i><span class="hidden-xs"> تاريخ</span></a></li>

        <li role="presentation" class="dropdown pull-right til-menu-right"> <a href="#" class="dropdown-toggle" id="myTabDrop1" data-toggle="dropdown" aria-controls="myTabDrop1-contents" aria-expanded="false"><i class="fa fa-cogs"></i><span class="hidden-xs"> خيارات</span> <span class="caret"></span></a>
            <ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                <li><a href="<?php site_url('admin/user/task/add.php?attachment&form_id='.$form->id); ?>" target="_blank"><i class="fa fa-tasks fa-fw"></i> إلحاق المهمة</a></li>
                <li><a href="<?php site_url('admin/user/message/add.php?attachment&form_id='.$form->id); ?>" target="_blank"><i class="fa fa-envelope-o fa-fw"></i> إضافة مرفق الرسالة</a></li>
                <li role="separator" class="divider"></li>
                <?php if($form->status == '1'): ?>
                    <li><a href="#"  data-toggle="modal" data-target="#status_item"><i class="fa fa-trash-o fa-fw text-danger"></i> حذف</a></li>
                <?php else: ?>
                    <li><a href="?id=<?php echo $form->id; ?>&status=1"><i class="fa fa-undo fa-fw text-success"></i> نشط</a></li>
                <?php endif; ?>
            </ul>
        </li>

        <li role="presentation" class="dropdown pull-right til-menu-right"> <a href="#" class="dropdown-toggle" id="myTabDrop1" data-toggle="dropdown" aria-controls="myTabDrop1-contents" aria-expanded="false"><i class="fa fa-print"></i><span class="hidden-xs"> طباعة</span> <span class="caret"></span></a>
            <ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                <li><a href="print.php?id=<?php echo $form->id; ?>&print" target="_blank"><i class="fa fa-fw fa-file-text-o"></i> نموذج الطباعة</a></li>
                <li><a href="print.php?id=<?php echo $form->id; ?>&print&showBarcode" target="_blank"><i class="fa fa-fw fa-file-text-o"></i> طباعة فاتورة باركود</a></li>
                <li><a href="print-invoice.php?id=<?php echo $form->id; ?>&print" target="_blank"><i class="fa fa-fw fa-file-archive-o"></i> طباعة الفاتورة</a></li>
            </ul>
        </li>
        ...
        <form name="form_add_accout" id="form_add_account" action="<?php if($form->id): ?>?id=<?php echo $form->id; ?><?php else: ?><?php endif; ?>" method="POST" class="validate">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-5">
                    <div class="form-group">
                        <label for="note"><i class="fa fa-pencil"></i> البيان <sup class="text-muted hidden-xs">*بإمكانك كتابة اي شئ حول هذه الفاتورة لتذكرها بشكل اسهل</sup> </label>
                        <input type="text" name="note" id="note" value="<?php echo @$form_meta->note; ?>" class="form-control input-sm"  maxlength="128" dir="auto">
                    </div> <!-- /.form-group -->
                </div> <!-- /.col- -->
                <div class="col-xs-6 col-md-2">
                    <div class="form-group">
                        <label for="account_fathername">اسم الاب </label>
                        <input type="text" name="account_fathername" id="account_fathername" value="<?php echo @$form->account_fathername; ?>" class="form-control input-sm"  maxlength="32">
                    </div> <!-- /.form-group -->
                </div> <!-- /.col-md-2 -->
                <div class="col-xs-6 col-md-2">
                    <div class="form-group">
                        <label for="account_countrynumber"> الرقم الوطني </label>
                        <input type="tel" name="account_countrynumber" id="account_countrynumber" value="<?php echo @$form->account_countrynumber; ?>" class="form-control input-sm"  maxlength="32">
                    </div> <!-- /.form-group -->
                </div> <!-- /.col-md-2 -->
            </div> <!-- /.row -->
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="account_code" id="account_code" value="<?php echo @$form->account_code; ?>" class="form-control input-sm"  maxlength="32">
                    </div> <!-- /.form-group -->
                </div> <!-- /.col-md-3 -->
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="account_name">اسم الحساب <?php if(@$form->account_id):?><a href="../account/detail.php?id=<?php echo $form->account_id; ?>" target="_blank"><i class="fa fa-external-link"></i></a><?php endif; ?> </label>
                        <label id="new_account" class="pull-right" data-toggle="tooltip" data-placement="top" title="" data-original-title="هل تريد اضافة حساب جديد"><input type="checkbox" name="new_account" id="new_account" value="true" data-toggle="switch" switch-size="xs" on-text="نعم" off-text="لا"></label>
                        <input type="text" name="account_name" id="account_name" value="<?php echo @$form->account_name; ?>" class="form-control input-sm"  maxlength="32">
                    </div> <!-- /.form-group -->
                </div> <!-- /.col-md-3 -->
                <div class="col-xs-6 col-md-2">
                    <div class="form-group">
                        <label for="account_gsm">الهاتف المحمول </label>
                        <input type="tel" name="account_gsm" id="account_gsm" value="<?php echo @$form->account_gsm; ?>" class="form-control input-sm"  maxlength="32">
                    </div> <!-- /.form-group -->
                </div> <!-- /.col-md-2 -->
                <div class="col-xs-6 col-md-2">
                    <div class="form-group">
                        <label for="account_Retardationtype">نوع الاعاقة </label>
                        <input type="text" name="account_Retardationtype" id="account_Retardationtype" value="<?php echo @$form->account_Retardationtype; ?>" class="form-control input-sm" >
                    </div> <!-- /.form-group -->
                </div> <!-- /.col-md-3 -->
                <div class="col-xs-12 col-md-2">
                    <div class="form-group">
                        <label for="account_Retardationnum"> رقم بطاقة الاعاقة </label>
                        <input type="tel" name="account_Retardationnum" id="account_Retardationnum" value="<?php echo @$form->account_Retardationnum; ?>" class="form-control input-sm ">
                    </div> <!-- /.form-group -->
                </div> <!-- /.col-md-3 -->
                ...
                <div class="col-xs-6 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="account_mo3el" id="account_mo3el" value="<?php echo @$form->account_mo3el; ?>" class="form-control input-sm">
                    </div> <!-- /.form-group -->
                </div> <!-- /.col- -->
            ...
            <div class="panel panel-default panel-table mobile-full" id="form_items">
                ...
                <?php if( is_alert('add_form_item') or is_alert('delete_form_item') ): ?><div    class="not-found">
                ...
                <table class="table table-condensed table-striped table-hover table-bordered">
                    ...
                    <tr class="border-none">
                        ...
                        <td width="50%" class="hidden-xs-portrait">
                            <div class="form-group">
                                <label for="item_code"><i class="fa fa-barcode hidden-xs"></i><span class="visible-xs">الكود</span> <span class="hidden-xs">باركود المعونة او المساعدة</span></label>
                        ...
                        <td class="hidden">
                            <div class="form-group hidden">
                                ...
                                <input type="hidden" name="quantity" value="1" id="quantity" class="form-control input-sm calc_item" >
                            </div> <!-- /.form-group -->
                        </td>
                        <td>
                            <div class="form-group hidden">
                                <label for="price">س.افرادي</label>
                                <input type="hidden"  pattern="[0-9]+([\.,][0-9]+)?" name="price" id="price" value="0" class="form-control input-sm money calc_item"  >
                            </div> <!-- /.form-group -->
                        </td>
                        <td class="hidden">
                            <div class="form-group">
                                <label for="total">س.إجمالي</label>
                                <input type="hidden" value="0" min="0" name="total" id="total" class="form-control input-sm money calc_item" >
                            </div> <!-- /.form-group -->
                        </td>
                        <td class="hidden">
                            <div class="form-group">
                                <label for="item_vat">VAT</label>
                                <input type="hidden" value="0" name="vat" id="vat" class="form-control input-sm calc_item">
                            </div> <!-- /.form-group -->
                        </td>
                        <td  class="hidden">
                            <div class="form-group">
                                <label for="vat_total"><span class="hidden-xs">T.VAT</span><span class="visible-xs fs-11">T.VAT</span></label>
                                <input type="hidden" value="0" min="0" name="vat_total" id="vat_total" class="form-control input-sm money calc_item">
                            </div> <!-- /.form-group -->
                        </td>
                        <td class="hidden">
                            <div class="form-group hidden">
                                <label for="col_total"><span class="hidden-xs">المجموع</span><span class="visible-xs">المجموع</span></label>
                                <input type="hidden" value="0" name="col_total" id="col_total" class="form-control input-sm money">
                            </div> <!-- /.form-group -->
                        </td>
                    </tr>
                    </thead>
                    ...
                    <?php if($form_items): ?>
                        ...
                        <?php foreach($form_items->list as $item): ?>
                            <tr class="<?php echo @$_GET['flashItemID'] == $item->item_id ? 'flashItemID' : ''; ?>">
                                <td class="text-center"><a href="?id=<?php echo $form->id; ?>&delete_form_item=<?php echo $item->id; ?>#form_items" title="حذف"><i class="fa fa-trash"></i></a></td>
                    ...
                    <?php if(til_is_mobile()): ?>
                        <tr class="fs-12">
                            ...
                            <th colspan="2" class=" hidden text-right fs-12"><?php echo get_set_money(@$form->total, true); ?></th>
                        </tr>
                    <?php else: ?>
                        <tr>
            ...
            <div class="btn-group btn-group-sm" style="margin: 15px 0;">
                <?php
                    ...
                    foreach ($db_result as $key => $item) :
                        ?>
                            <a class="btn btn-primary" href="javascript:void(0);" data-toggle="js-fill-input" data-code="<?= $item['code']; ?>" data-name="<?= $item['name']; ?>">
                                <?= $item['name']; ?>
                            </a>
                        <?php
                    endforeach;
            ...
            <div class="text-right">
                <div class="h-20 visible-xs"></div>
                <button class="btn btn-success btn-xs-block btn-insert btn-save"><i class="fa fa-floppy-o"></i> حفظ</button>
                <a class="btn btn-warning" href="<?php site_url("admin/form/detail.php?in"); ?>"><i class="fa fa-floppy-o"></i>توزيع جديد</a>
            </div><!-- /.text-right -->
