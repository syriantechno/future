...
<?php if($export_type == 'print') { get_header_print(array('title'=>'قائمة النماذج')); } ?>
		...
		<table class="table table-hover table-bordered table-condensed">
			...
			<?php foreach($forms->list as $form): ?>
				...
				<tr>
					...
					<td class="text-center"><span class="text-muted"  data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $form->item_count; ?> منتج مختلف"><?php echo $form->item_quantity; ?> العدد</span></td>
