				...
				<div class="col-md-6" style="display: flex">
                    ...
                    <form action="<?= $_SERVER['PHP_SELF']; ?>" method="get" class="form-inline">
                        <div class="form-group">
                            ...
                            ?>
                            <input type="text" name="from_date" class="form-control input-sm date" placeholder="من" value="<?= $from_date; ?>" style="width: 30%;">
                            <input type="text" name="to_date" class="form-control input-sm date" placeholder="إلى" value="<?= $to_date; ?>" style="width: 30%;">
...
<!--						    <li><a href="--><?php //echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'pdf', 'limit'=>'false')))); ?><!--">تصدير الكل <sup class="text-muted">(--><?php //echo $forms->num_rows; ?><!--)</sup></a></li>-->
<!--						  </ul>-->
<!--						</div>-->
						...
						<div class="btn-group btn-icon" data-toggle="tooltip" data-placement="top" title="Excel" >
						  ...
						  <ul class="dropdown-menu dropdown-menu-right">
						    ...
						    <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'excel', 'limit'=>'false')))); ?>">تصدير الكل <sup class="text-muted">(<?php echo $forms->num_rows; ?>)</sup></a></li>
						  </ul>
						</div>
						...
						<div class="btn-group btn-icon" data-toggle="tooltip" data-placement="top" title="طباعة" >
						  ...
						  <ul class="dropdown-menu dropdown-menu-right">
						    ...
						    <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'print')))); ?>" target="_blank">طباعة قائمة نشطة</a></li>
						    <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'print', 'limit'=>'false')))); ?>" target="_blank">طباعة الكل <sup class="text-muted">(<?php echo $forms->num_rows; ?>)</sup></a></li>
						    <li class="divider"></li>
						    <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'print', 'addBarcode'=>true)))); ?>" target="_blank">طباعة قائمة الباركود النشطة</a></li>
						    <li><a href="<?php echo str_replace('list.php', 'export.php', get_set_url_parameters(array('add'=> array('export'=>'print', 'limit'=>'false', 'addBarcode'=>true)))); ?>" target="_blank">طباعة باركود <sup class="text-muted">(<?php echo $forms->num_rows; ?>)</sup></a></li>
						  </ul>
						</div>
			...
			<table class="table table-hover table-bordered table-condensed table-striped">
				...
				<?php foreach($forms->list as $form): ?>
					...
					<tr>
						...
						<td><?php if($form->account_id): ?><a href="../account/detail.php?id=<?php echo $form->account_id; ?>#forms" target="_blank"><i class="fa fa-external-link" aria-hidden="true"></i> <?php echo $form->account_name; ?></a> <?php else: ?><?php echo $form->account_name; ?><?php endif; ?></td>
						<td><?php echo $form->account_gsm; ?></td>
						<td class="text-center">
						<span class="text-muted"  data-toggle="tooltip" data-placement="top" title="" data-original-title=
						" فاتورة بحركة منتج <?php echo $form->item_count; ?> ">
						 ...
						 <?php
								if($form->type=='form') {
									...
									if($form->in_out == '0') { echo 'دفعة منه'; } else { echo 'دفعة له'; }
								}
								?>
						  </span></td>
						<td class="text-right"><?php echo get_set_money($form->item_count, true); ?></td>
