	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<div class="row space-5">
				...
				<div class="box-menu">
					<a href="<?php site_url('admin/form/detail.php?in'); ?>">
						<span class="icon-box3">
                            ...
                            <i class="faw fa-cart-arrow-down"style="color: rgba(255, 255, 255, 0.4117647058823529);"></i>
                        <hr>
            ...
            <div class="col-md-12">
                ...
                <small class="text-muted module-title-small"><i class="fa fa-cart-arrow-down"></i> احدث عمليات التوزيع</small>
                <div class="h-10"></div>
