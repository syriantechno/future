...
<ul class="nav nav-tabs" role="tablist"> 
	<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><i class="fa fa-id-card-o"></i> ملفي الشخصي</a></li> 
		...
		<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="gsm" id="gsm" value="<?php echo $active->gsm; ?>" class="form-control digits" minlength="3" maxlength="11">
						</div> <!-- /.form-group -->
					</div> <!-- /.col-md-6 -->
				</div> <!-- /.row -->
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="username" id="username" value="<?php echo $active->username; ?>" class="form-control" minlength="3" maxlength="20">
						</div> <!-- /.form-group -->
					</div> <!-- /.col-md-6 -->
					<div class="col-md-6">
						<div class="form-group">
			...
			<div class="col-md-2">
				...
				<div class="img-thumbnail">
					...
					<div class="h-10"></div>
					<a href="?id=<?php echo $active->id; ?>&delete_avatar" class="pull-right text-danger fs-12"><i class="fa fa-trash"></i> حذف هذه الصورة</a>
				</div> <!-- /img-thumbnail -->
