			...
			<div class="panel-body">
				...
				<form name="form_staff_salary" id="form_staff_salary" action="" method="POST">
					<div class="form-group">
						<label class="pointer"><input type="checkbox" name="is_salary" id="is_salary" value="1" data-toggle="switch" text-on="نعم" text-off="لا" class="til-hide-show" data-e="_is_salary" <?php checked(@$user_meta['is_salary'], '1'); ?>> <span>&nbsp;هل يتم حساب الراتب؟ </span> </label>
					</div> <!-- /.form-group -->
					...
					<div class="row _is_salary">
						...
						<div class="col-md-4">
							<div class="form-group">
								<label for="net_salary">صافي الراتب <small class="text-muted">(شهريا)</small></label>
	...
	<div class="col-md-6">
		...
		<div class="panel panel-default _is_salary">
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-md-6">
						<h4>إجمالي الرصيد : <span class="<?php echo $account->balance < 0 ? 'text-danger' : 'text-success'; ?>"><?php echo get_set_money($account->balance,true); ?></span></h4>
					</div> <!-- /.col-md-6 -->
					<div class="col-md-6 text-right">
						<a href="<?php site_url('admin/payment/detail.php?out'); ?>&template=salary&account_id=<?php echo $user->account_id; ?>&user_type=user" target="_blank" class="btn btn-warning"><i class="fa fa-paypal"></i> إجراء الدفع</a>
					</div> <!-- /.col-md-6 -->
				</div> <!-- /.row -->
