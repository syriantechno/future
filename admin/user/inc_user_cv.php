				...
				<div class="col-md-6">
						...
						<div class="panel-heading">
							...
							<div class="panel-menu">
								<div class="btn-group btn-group-xs" role="group">
								  	<a href="#" onclick="return false;" class="btn btn-default" data-function="add_div_item" data-div=".div_school" data-max_element="5"><i class="fa fa-plus-square"></i> إضافة</a>
								</div>
							</div> <!-- /.panel-menu -->
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<select name="school_level[]" id="school_level" class="form-control input-sm">
														<option <?php selected(@$school->school_level, 'primary_education'); ?> value="primary_education">التعليم الإبتدائي</option>
														<option <?php selected(@$school->school_level, 'high_school'); ?> value="high_school">اساسي</option>
														<option <?php selected(@$school->school_level, 'college'); ?> value="college">كلية</option>
														<option <?php selected(@$school->school_level, 'university'); ?> value="university">جامعة</option>
														<option <?php selected(@$school->school_level, 'other'); ?> value="other">اخرى</option>
													</select>
												</div> <!-- /.form-group -->
											</div> <!-- /.col-md-2 -->
											<div class="col-md-3">
					...
					<div class="panel panel-default panel-border-top">
						<div class="panel-heading">
							...
							<div class="panel-menu">
								<div class="btn-group btn-group-xs" role="group">
								  	<a href="#" onclick="return false;" class="btn btn-default" data-function="add_div_item" data-div=".div_language" data-max_element="3"><i class="fa fa-plus-square"></i> إضافة</a>
								</div>
							</div> <!-- /.panel-menu -->
						...
						<div class="panel-body">
											...
											<div class="col-md-5">
												<div class="form-group">
													...
													<select name="lang_lang[]" id="lang_lang" class="form-control input-sm">
														...
														<option value="Türkçe" <?php selected(@$language->lang_lang, 'Türkçe'); ?>>التركية</option>
														<option value="İngilizce" <?php selected(@$language->lang_lang, 'İngilizce'); ?>>الانكليزية</option>
														<option value="Almanca" <?php selected(@$language->lang_lang, 'Almanca'); ?>>الالمانية</option>
														<option value="Fransızca" <?php selected(@$language->lang_lang, 'Fransızca'); ?>>الفرنسية</option>
														<option value="İtalyanca" <?php selected(@$language->lang_lang, 'İtalyanca'); ?>>الايطالية</option>
														<option value="Arapça" <?php selected(@$language->lang_lang, 'Arapça'); ?>>العربية</option>
														<option value="Kürtçe" <?php selected(@$language->lang_lang, 'Kürtçe'); ?>>الكرواتية</option>
														<option value="Zazaca" <?php selected(@$language->lang_lang, 'Zazaca'); ?>>Zazaca</option>
														<option value="Azerice" <?php selected(@$language->lang_lang, 'Azerice'); ?>>الازردية</option>
														<option value="Boşnakça" <?php selected(@$language->lang_lang, 'Boşnakça'); ?>>البوسنية</option>
														<option value="Bulgarca" <?php selected(@$language->lang_lang, 'Bulgarca'); ?>>البلغارية</option>
														<option value="Çekçe" <?php selected(@$language->lang_lang, 'Çekçe'); ?>>التشيكية</option>
														<option value="Çince" <?php selected(@$language->lang_lang, 'Çince'); ?>>الصينية</option>
														<option value="Danca" <?php selected(@$language->lang_lang, 'Danca'); ?>>دانماركي</option>
														<option value="Ermenice" <?php selected(@$language->lang_lang, 'Ermenice'); ?>>الارمنية</option>
														<option value="Eskiçağ Dilleri" <?php selected(@$language->lang_lang, 'Eskiçağ Dilleri'); ?>>اللغات القديمة</option>
														<option value="Farsça" <?php selected(@$language->lang_lang, 'Farsça'); ?>>الفارسية</option>
														...
														<option value="Hırvatça" <?php selected(@$language->lang_lang, 'Hırvatça'); ?>>الكرواتية</option>
														<option value="İbranice" <?php selected(@$language->lang_lang, 'İbranice'); ?>>İbranice</option>
														<option value="İspanyolca" <?php selected(@$language->lang_lang, 'İspanyolca'); ?>>الأسبانية</option>
														...
														<option value="Japonca" <?php selected(@$language->lang_lang, 'Japonca'); ?>>اليابانية</option>
														<option value="Korece" <?php selected(@$language->lang_lang, 'Korece'); ?>>الكورية</option>
														<option value="Latince" <?php selected(@$language->lang_lang, 'Latince'); ?>>لاتينية</option>
														<option value="Lehçe" <?php selected(@$language->lang_lang, 'Lehçe'); ?>>البولندية</option>
														<option value="Norveççe" <?php selected(@$language->lang_lang, 'Norveççe'); ?>>النرويجية</option>
														<option value="Portekizce" <?php selected(@$language->lang_lang, 'Portekizce'); ?>>البرتغالية</option>
														<option value="Romence" <?php selected(@$language->lang_lang, 'Romence'); ?>>Romence</option>
														<option value="Rusça" <?php selected(@$language->lang_lang, 'Rusça'); ?>>الروسية</option>
														<option value="Yunanca" <?php selected(@$language->lang_lang, 'Yunanca'); ?>>اليونانية</option>
														<option value="Flamanca" <?php selected(@$language->lang_lang, 'Flamanca'); ?>>هولندي</option>
														<option value="Slav dilleri" <?php selected(@$language->lang_lang, 'Slav dilleri'); ?>>السلافية</option>
														<option value="Kazakça" <?php selected(@$language->lang_lang, 'Kazakça'); ?>>الكازاخية</option>
														<option value="Kırgızca" <?php selected(@$language->lang_lang, 'Kırgızca'); ?>>القيرغستانية</option>
														<option value="Özbekçe" <?php selected(@$language->lang_lang, 'Özbekçe'); ?>>الأوزبكي</option>
														<option value="Sırpça" <?php selected(@$language->lang_lang, 'Sırpça'); ?>>صربي</option>
														<option value="Slovakça" <?php selected(@$language->lang_lang, 'Slovakça'); ?>>السلوفاكية</option>
														<option value="Slovence" <?php selected(@$language->lang_lang, 'Slovence'); ?>>سلوفينيا</option>
														<option value="Tatarca" <?php selected(@$language->lang_lang, 'Tatarca'); ?>>تتاري</option>
														<option value="Urduca" <?php selected(@$language->lang_lang, 'Urduca'); ?>>الأردية</option>
														<option value="İskandinav Dilleri" <?php selected(@$language->lang_lang, 'İskandinav Dilleri'); ?>>اللغات الاسكندنافية</option>
														<option value="Macarca" <?php selected(@$language->lang_lang, 'Macarca'); ?>>الهنغارية</option>
														<option value="Gürcüce" <?php selected(@$language->lang_lang, 'Gürcüce'); ?>>الجورجية</option>
														<option value="Ukraynaca" <?php selected(@$language->lang_lang, 'Ukraynaca'); ?>>الأوكراني</option>
														<option value="Letonca" <?php selected(@$language->lang_lang, 'Letonca'); ?>>اللاتفية</option>
														<option value="Makedonca" <?php selected(@$language->lang_lang, 'Makedonca'); ?>>المقدونية</option>
													</select>
												</div> <!-- /.form-group -->
											</div> <!-- /.col-md-2 -->
											<div class="col-md-2">
												<div class="form-gorup">
													...
													<select name="lang_reading[]" id="lang_reaing" class="form-control input-sm">
														<option value="1" <?php selected(@$language->lang_reading, '1'); ?>>لا</option>
														<option value="2" <?php selected(@$language->lang_reading, '2'); ?>>وسط</option>
														<option value="3" <?php selected(@$language->lang_reading, '3'); ?>>جيد</option>
														<option value="4" <?php selected(@$language->lang_reading, '4'); ?>>جيد جدا</option>
													</select>
												</div> <!-- /.form-group -->
											</div> <!-- /.col-md-2 -->
											<div class="col-md-2">
												<div class="form-gorup">
													...
													<select name="lang_writing[]" id="lang_writing" class="form-control input-sm">
														<option value="1" <?php selected(@$language->lang_writing, '1'); ?>>لا</option>
														<option value="2" <?php selected(@$language->lang_writing, '2'); ?>>وسط</option>
														<option value="3" <?php selected(@$language->lang_writing, '3'); ?>>جيد</option>
														<option value="4" <?php selected(@$language->lang_writing, '4'); ?>>جيد جدا</option>
													</select>
												</div> <!-- /.form-group -->
											</div> <!-- /.col-md-2 -->
											<div class="col-md-2">
												<div class="form-gorup">
													...
													<select name="lang_talk[]" id="lang_talk" class="form-control input-sm">
														<option value="1" <?php selected(@$language->lang_talk, '1'); ?>>لا</option>
														<option value="2" <?php selected(@$language->lang_talk, '2'); ?>>وسط</option>
														<option value="3" <?php selected(@$language->lang_talk, '3'); ?>>جيد</option>
														<option value="4" <?php selected(@$language->lang_talk, '4'); ?>>جيد جدا</option>
													</select>
												</div> <!-- /.form-group -->
											</div> <!-- /.col-md-2 -->
											<div class="col-md-1 text-right">
							...
							<div class="pull-right">
								<a href="#" onclick="return false;" class="btn btn-default btn-xs" data-function="add_div_item" data-div=".div_language" data-max_element="5"><i class="fa fa-plus-square"></i> إضافة</a>
							</div>
					...
					<div class="panel panel-default panel-border-top">
						<div class="panel-heading">
							...
							<div class="panel-menu">
								<div class="btn-group btn-group-xs" role="group">
								  	<a href="#" onclick="return false;" class="btn btn-default" data-function="add_div_item" data-div=".div_ref" data-max_element="5"><i class="fa fa-plus-square"></i> إضافة</a>
								</div>
							</div> <!-- /.panel-menu -->
				...
				<div class="col-md-6">
					...
					<div class="panel panel-default panel-border-top">
						<div class="panel-heading">
							...
							<div class="panel-menu">
								<div class="btn-group btn-group-xs" role="group">
								  	<a href="#" onclick="return false;" class="btn btn-default" data-function="add_div_item" data-div=".div_work" data-max_element="5"><i class="fa fa-plus-square"></i> إضافة</a>
								</div>
							</div> <!-- /.panel-menu -->
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<select name="work_level[]" id="work_level" class="form-control input-sm">
														<option <?php selected(@$work->work_level, 'full_time'); ?> value="full_time">دوام كامل</option>
														<option <?php selected(@$work->work_level, 'part_time'); ?> value="part_time">دوام جزئي</option>
														<option <?php selected(@$work->work_level, 'seasonal'); ?> value="seasonal">دوري</option>
														<option <?php selected(@$work->work_level, 'contractual'); ?> value="contractual">تعاقدي</option>
														<option <?php selected(@$work->work_level, 'student'); ?> value="student">المتدرب</option>
													</select>
												</div> <!-- /.form-group -->
											</div> <!-- /.col-md-2 -->
											<div class="col-md-2">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<select name="unhealthy_type" id="unhealthy_type" class="form-control input-sm">
												<option value="" <?php selected('', @$user_meta['unhealthy_type']); ?>>حدد...</option>
												<option value="Damar Hastalıkları" <?php selected('Damar Hastalıkları', @$user_meta['unhealthy_type']); ?>>أمراض الأوعية الدموية</option>
												<option value="Deri Hastalıkları" <?php selected('Deri Hastalıkları', @$user_meta['unhealthy_type']); ?>>الأمراض الجلدية</option>
												<option value="Göğüs Hastalıkları" <?php selected('Göğüs Hastalıkları', @$user_meta['unhealthy_type']); ?>>أمراض الصدر</option>
												<option value="Göz Arızaları" <?php selected('Göz Arızaları', @$user_meta['unhealthy_type']); ?>>امراض العين</option>
												<option value="Hematolojik Hastalıklar" <?php selected('Hematolojik Hastalıklar', @$user_meta['unhealthy_type']); ?>>أمراض الدم</option>
												<option value="İç Hastalıklar" <?php selected('İç Hastalıklar', @$user_meta['unhealthy_type']); ?>>امراض داخلية</option>
												<option value="Karın Hastalıkları" <?php selected('Karın Hastalıkları', @$user_meta['unhealthy_type']); ?>>أمراض البطن</option>
												<option value="Kulak Burun Boğaz" <?php selected('Kulak Burun Boğaz', @$user_meta['unhealthy_type']); ?>>الأذن الأنف الحنجرة</option>
												<option value="Nörolojik Hastalıklar" <?php selected('Nörolojik Hastalıklar', @$user_meta['unhealthy_type']); ?>>الأمراض العصبية</option>
												<option value="Onkoloji" <?php selected('Onkoloji', @$user_meta['unhealthy_type']); ?>>اورام خبيثة</option>
												<option value="Ortopedik ve Travmatolojik" <?php selected('Ortopedik ve Travmatolojik', @$user_meta['unhealthy_type']); ?>>العظام والصدمات النفسية</option>
												<option value="Ruh Hastalıkları" <?php selected('Ruh Hastalıkları', @$user_meta['unhealthy_type']); ?>>مرض عقلي</option>
												<option value="Sindirim Sistemi" <?php selected('Sindirim Sistemi', @$user_meta['unhealthy_type']); ?>>الجهاز الهضمي</option>
												<option value="Üroloji" <?php selected('Üroloji', @$user_meta['unhealthy_type']); ?>>المسالك البولية</option>
												<option value="Yanıklar" <?php selected('Yanıklar', @$user_meta['unhealthy_type']); ?>>الحروق</option>
											</select> <!-- /.form-control -->
										</div>
									</div> <!-- /.col-md-* -->
									<div class="col-md-3">
										<div class="form-group">
											...
											<select name="unhealthy_degree" id="unhealthy_degree" class="form-control input-sm">
												<option value="" <?php selected('', @$user_meta['unhealthy_degree']); ?>>حدد...</option>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<select name="terror_type" id="terror_type" class="form-control input-sm">
												<option value="" <?php selected('', @$user_meta['terror_type']); ?>>حدد...</option>
												<option value="Şehit Eşi" <?php selected('Şehit Eşi', @$user_meta['terror_type']); ?>>الزوجة شهيدة</option>
												<option value="Şehit Çocuğu" <?php selected('Şehit Çocuğu', @$user_meta['terror_type']); ?>>الاطفال شهداء</option>
												<option value="Şehit Kardeşi" <?php selected('Şehit Kardeşi', @$user_meta['terror_type']); ?>>الاخ شهيد</option>
												<option value="Kendisi" <?php selected('Kendisi', @$user_meta['terror_type']); ?>>هو شهيد</option>
											</select> <!-- /.form-control -->
										</div>
									</div> <!-- /.col-md-* -->
									<div class="col-md-7">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input type="text" name="url_website" id="url_website" class="form-control url" maxlength="255" value="<?php echo @$user_meta['url_website']; ?>" placeholder="www.name.com">
									</div> <!-- /.form-group -->

									<div class="form-group">
										<label for="url_facebook">فيس بوك</label>
										<input type="text" name="url_facebook" id="url_facebook" class="form-control url" maxlength="255" value="<?php echo @$user_meta['url_facebook']; ?>" placeholder="www.facebook.com/name">
									</div> <!-- /.form-group -->
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input type="text" name="url_linkedin" id="url_linkedin" class="form-control url" maxlength="255" value="<?php echo @$user_meta['url_linkedin']; ?>" placeholder="www.linkedin.com/name">
									</div> <!-- /.form-group -->

									<div class="form-group">
										<label for="url_twitter">تويتر</label>
										<input type="text" name="url_twitter" id="url_twitter" class="form-control url" maxlength="255" value="<?php echo @$user_meta['url_twitter']; ?>" placeholder="www.twitter.com/name">
									</div> <!-- /.form-group -->
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<select name="is_married" id="is_married" class="select form-control js_til_select_div" data-div=".div_is_married">
											<option value="" <?php selected(@$user_meta['is_married'], ''); ?>>غير معروف</option>
											<option value="not_married" <?php selected(@$user_meta['is_married'], 'not_married'); ?>>أعزب</option>
											<option value="married" <?php selected(@$user_meta['is_married'], 'married'); ?>>متزوج</option>
											<option value="widow" <?php selected(@$user_meta['is_married'], 'widow'); ?>>لديه اولاد</option>
										</select>
									</div> <!-- /.form-group -->
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<select name="military_status" id="military_status" class="select form-control js_til_select_div" data-div=".div_military">
											<option value="" <?php selected(@$user_meta['military_status'], ''); ?>>غير معروف</option>
											<option value="done" <?php selected(@$user_meta['military_status'], 'done'); ?>>أدى خدمته الالزامية</option>
											<option value="postponed" <?php selected(@$user_meta['military_status'], 'postponed'); ?>>لديه تأجيل</option>
											<option value="exempt" <?php selected(@$user_meta['military_status'], 'exempt'); ?>>معفى</option>
										</select>
									</div> <!-- /.form-group -->
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="blood_group" id="blood_group" class="select form-control">
											<option value="" <?php selected(@$user_meta['blood_group'], ''); ?>>غير معروف</option>
