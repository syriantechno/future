	...
	<div class="panel-body">
		...
		<div class="list-group list-group-messagebox">
            ...
            <?php $box = 'inbox';?>
		  	...
		  	<!-- outbox -->
		  	<a href="list.php?box=outbox" class="list-group-item <?php echo $box == 'outbox' ? 'active' : ''; ?>"><i class="fa fa-mail-reply fa-fw"></i> صندوق الحفظ <span class="badge"><?php echo get_calc_message(array('query'=>_get_query_message('outbox'))); ?></span></a>
		  	<!-- trash -->
		  	<a href="list.php?box=trash" class="list-group-item <?php echo $box == 'trash' ? 'active' : ''; ?>"><i class="fa fa-trash-o fa-fw"></i> سلة المهملات <span class="badge"><?php echo get_calc_message(array('query'=>_get_query_message('trash'))); ?></span></a>
		</div>
	</div> <!-- /.panel-body -->
</div> <!-- /.panel -->