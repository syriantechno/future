...
<div class="print-page" size="A4">
	...
	<div class="row">
		<div class="col-xs-4">
			...
			<table class="table table-condensed table-condensed">
				<tr><td class="bold">رقم الهوية</td><td><?php echo $user->citizenship_no; ?></td></tr>
				<tr><td class="bold">الجنس</td><td><?php echo $user->gender ? 'رجل' : 'سيدة'; ?></td></tr>
				<tr><td class="bold" width="100">Adı</td><td><?php echo $user->name; ?></td></tr>
				<tr><td class="bold">اللقب / الشهرة</td><td><?php echo $user->surname; ?></td></tr>
				<tr><td class="bold">تاريخ الميلاد</td><td><?php echo @$user_meta['date_birth']; ?></td></tr>
				<tr><td class="bold">مكان الميلاد</td><td><?php echo @$user_meta['birthplace']; ?></td></tr>
				<?php if(@$user_meta['blood_group']): ?><tr><td class="bold">فصيلة الدم</td><td><?php echo @$user_meta['blood_group']; ?></td></tr><?php endif; ?>
				<tr><td class="bold">الخليوي</td><td><?php echo $user->gsm; ?></td></tr>
				<?php if(!empty(@$user_meta['driving_license'])): ?>
					<tr><td class="bold">رخصة القيادة</td><td><?php echo implode(", ", @$user_meta['driving_license']); ?></td></tr>
				<?php endif; ?>
			...
			<table class="table table-condensed table-condensed">
				<tr><td class="bold">اسم الأب</td><td><?php echo @$user_meta['father_name']; ?></td></tr>
				<tr><td class="bold">اسم الام</td><td><?php echo @$user_meta['mother_name']; ?></td></tr>
				<?php if(@$user_meta['is_married']): ?>
					<tr><td class="bold" width="100">الحالة المدنية</td><td><?php echo _get_usermeta_is_married(@$user_meta['is_married']); ?></td></tr>
				<?php endif; ?>
				<?php if(@$user_meta['spouses_name']): ?>
					<tr><td class="bold">اسم زوجتك</td><td><?php echo @$user_meta['spouses_name']; ?></td></tr>
				<?php endif; ?>
				<?php if(@$user_meta['children_count']): ?>
					<tr><td class="bold">عدد الأطفال</td><td><?php echo @$user_meta['children_count']; ?></td></tr>
				<?php endif; ?>
				<?php if(@$user_meta['humble_person_count']): ?>
					<tr><td colspan="2">خارج الأسرة <b><?php echo @$user_meta['humble_person_count']; ?></b> المعالين من الأشخاص.</td></tr>
				<?php endif; ?>
			</table>
			...
			<?php if(@$user_meta['unhealthy']): ?>
				...
				<table class="table table-condensed table-condensed">
					<tr><td class="bold" width="100">درجة الاعاقة</td><td><?php echo @$user_meta['unhealthy_type']; ?></td></tr>
					<tr><td class="bold">درجة</td><td><?php echo @$user_meta['unhealthy_degree']; ?></td></tr>
				</table>
			<?php endif; ?>
			...
			<?php if(@$user_meta['prison']): ?>
				...
				<table class="table table-condensed table-condensed">
					<tr><td class="bold" width="100">وقت</td><td><?php echo @$user_meta['prison_year']; ?> Yıl <?php echo @$user_meta['prison_month']; ?> Ay</td></tr>
					<tr><td class="bold">البيان</td><td><?php echo @$user_meta['prison_desc']; ?></td></tr>
				</table>
			<?php endif; ?>
			...
			<?php if(@$user_meta['terror']): ?>
				...
				<table class="table table-condensed table-condensed">
					<tr><td class="bold" width="100">قرب</td><td><?php echo @$user_meta['terror_type']; ?></td></tr>
					<tr><td class="bold">البيان</td><td><?php echo @$user_meta['terror_desc']; ?></td></tr>
				</table>
			<?php endif; ?>
	...
	<div class="print-footer print-footer-left">
		<small class="text-muted"><img src="<?php site_url('content/themes/default/img/logo_header.png'); ?>" class="img-responsive pull-left" width="64"> برمجيات مفتوحة المصدر.</small>
	</div>
