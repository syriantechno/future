			...
			<div class="row">
				<div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="username" id="username" class="form-control required" minlength="3" maxlength="20" value="<?php echo @$_user['username']; ?>">
                    </div> <!-- /.form-group -->
                </div> <!-- /.col-md-6 -->
                <div class="col-md-6">
                    <div class="form-group">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="email" name="email" id="email" class="form-control  email" value="<?php echo @$_user['email']; ?>">
					</div> <!-- /.form-group -->
				</div> <!-- /.col-md-6 -->
				<div class="col-md-6">
					<div class="form-group">
						<label for="text">الهاتف المحمول</label>
						<input type="tel" name="gsm" id="gsm" class="form-control  digits" minlength="1" maxlength="25" value="<?php echo @$_user['gsm']; ?>">
					</div> <!-- /.form-group -->
				</div> <!-- /.col-md-6 -->
			</div> <!-- /.row -->
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="tel" name="citizenship_no" id="citizenship_no" class="form-control digits" minlength="1" maxlength="25" value="<?php echo @$_user['citizenship_no']; ?>">
					</div> <!-- /.form-group -->
				</div> <!-- /.col-md-6 -->
			</div> <!-- /.row -->
