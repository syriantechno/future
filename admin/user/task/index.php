    ...
    <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
        <div class="row space-5">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-2">
              ...
              <i class="fa fa-tasks"></i>
              <span class="badge" id="box_menu_task_badge"
                    js-onload="get_notification_count({elem: '#box_menu_task_badge', box: 'task'})"><?php echo $message_unread = get_calc_task(); ?></span>
            </span>
                        <h3>المهمة الواردة</h3>
                    </a>
                </div> <!-- /.box-menu -->
            </div> <!-- /.col-* -->
        </div><!--/ .row /-->
    ...
    <div class="col-md-8">
        ...
        <script type="text/javascript">
            document.addEventListener('DOMContentLoaded', function () {
                calendar('#calendar', '<?php if (!empty($json)) {
                    echo $json;
                } ?>');
            });
        </script>
