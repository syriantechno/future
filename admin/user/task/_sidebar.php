...
<?php $box='inbox'; $type_status='0';?>
		<div class="list-group list-group-messagebox">
		  	...
		  	?>
		  	<a href="list.php?box=trash" class="list-group-item <?php echo $box == 'trash' ? 'active' : ''; ?>"><i class="fa fa-trash-o"></i> سلة المهملات <span class="badge"><?php echo get_calc_task(array('query'=>_get_query_task('trash'))); ?></span></a>
		</div>
	</div> <!-- /.panel-body -->
</div> <!-- /.panel -->