							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="date_start"><i class="fa fa-calendar"></i> تاريخ البدء</label>
												<input type="text" name="date_start" id="date_start" class="form-control required datetime" value="<?php echo date('Y-m-d H:i'); ?>">
											</div> <!-- /.form-group -->
										</div> <!-- /.col-md-6 -->
										<div class="col-md-6">
											<div class="form-group">
												<label for="date_end"><i class="fa fa-calendar"></i> تاريخ الإنجاز</label>
						...
						<div class="col-md-6">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									<div class="text-right"><button type="button" class="btn btn-default btn-xs" id="addChoice"><i class="fa fa-plus"></i> إضافة خيار</button></div>
								</div><!--/ .panel-body /-->
							</div> <!-- /.panel-default -->
						</div> <!-- /.col-md-6 -->
					</div> <!-- /.row -->
