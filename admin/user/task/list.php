...
if(isset($_GET['box'])) {
	$box = 'inbox';
	if($_GET['box'] == 'inbox') { $box = 'inbox'; add_page_info('title', 'صندوق المهام - قادم'); }
	elseif($_GET['box'] == 'outbox') { $box = 'outbox'; add_page_info('title', 'صندوق المهام - المنتهية'); }
	elseif($_GET['box'] == 'trash') { $box = 'trash'; add_page_info('title', 'صندوق المهام - محذوفات'); }
} else { $box = 'inbox'; }
...
if(isset($_GET['move'])) {
	...
	} else { add_alert('لم يتم العثور على معرف المهمة.', 'warning', false); }
}
