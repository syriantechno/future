...
if(!$monthly = get_form(array('id'=>@$_GET['id'], 'type'=>'salary')) ) { echo get_alert('لم يتم العثور على نموذج الراتب.', 'warning', false); get_footer(); return false; }

// إذا لم يكن لديك معلومات الموظفين وليس لديك معلومات الموظفين إيغر،
if(!$user = get_user($monthly->user_id)) { echo get_alert('لم يتم العثور على معلومات الموظفين.', 'warning', false); get_footer(); return false; }
...
<div class="row">
	...
	<div class="col-lg-9 col-md-8">
		...
		<div class="panel panel-default panel-table">
			<div class="panel-heading"><h3 class="panel-title"><?php echo til_get_date($monthly->date, 'F Y'); ?> تفاصيل الراتب</h3></div>
					...
					<div class="row space-5">
						...
						<div class="col-md-8">
							...
							<div class="div_wage_status" data-div_selected="did_not_come">
								...
								<div class="form-group">
									<label><input type="checkbox" name="dnc_wage_cut" id="dnc_wage_cut" value="1"> هل تدفع لأيام عندما كنت لا تأتي?</label>
								</div> <!-- /.form-group -->
							...
							<div class="div_wage_status" data-div_selected="to_let">
								...
								<div class="form-group">
									<label><input type="checkbox" name="let_wage_cut" id="let_wage_cut" value="1"> هل تتم محاسبتك في أيام الإجازة?</label>
								</div> <!-- /.form-group -->
