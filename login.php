  ...
  <div class="row">
    ...
    <div class="col-xs-16 col-md-15">
      <div class="loginbox">
        ...
        <div>
          <img src="<?php echo _site_url; ?>/content/themes/default/img/login_header.png" class="img-responsive" style="margin: auto;" >
   
        </div>
        <div class="h20"></div>

        <?php if($login_form_error): ?>
          <div class="alert alert-danger alert-loginError" role="alert"> <strong><i class="fa fa-exclamation-triangle"></i> خطا </strong>اسم المستخدم وكلمة المرور غير صحيحة</div>
          <style type="text/css">
            .alert-loginError{
        ...
        <form name="form_login" id="form_login" action="" method="POST" class="validation">
          ...
          <div class="form-group">
            <input type="password" name="password" id="password" class="form-control input-lg required" value="<?php echo @$password; ?>" placeholder="?ifre">
          </div> <!-- /.form-group -->
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="checkbox">
                <label>
                  <input type="checkbox"> <span class="text-muted">حفظ اسم المستخدم وكلمة المرور</span>
                </label>
              </div> <!-- /.checkbox -->
            </div> <!-- /.col-md-6 -->
            <div class="col-md-6">
