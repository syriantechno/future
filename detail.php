...
<ul class="nav nav-tabs til-nav-page" role="tablist"> 
	<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><i class="fa fa-id-card-o"></i><span class="hidden-xs"> بطاقة الحساب</span></a></li> 
	<li role="presentation" class=""><a href="#forms" role="tab" id="forms-tab" data-toggle="tab" aria-controls="forms" aria-expanded="false"><i class="fa fa-list"></i><span class="hidden-xs">كشف الحساب</span></a></li> 
	...
	<li role="presentation" class="dropdown pull-right til-menu-right"> <a href="#" class="dropdown-toggle" id="myTabDrop1" data-toggle="dropdown" aria-controls="myTabDrop1-contents" aria-expanded="false"><i class="fa fa-cogs"></i><span class="hidden-xs"> خيارات</span><span class="caret"></span></a> 
		<ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents"> 
			<li><a href="<?php site_url('admin/user/message/add.php?attachment&account_id='.$account->id); ?>" target="_blank"><i class="fa fa-tasks fa-fw"></i> إلحاق المهمة</a></li>
			<li><a href="<?php site_url('admin/user/message/add.php?attachment&account_id='.$account->id); ?>" target="_blank"><i class="fa fa-envelope-o fa-fw"></i> إضافة مرفق الرسالة</a></li>
			<li class="divider"></li>
			<?php if($account->status == '1'): ?>
				<li><a href="#" target="_blank" data-toggle="modal" data-target="#status_account"><i class="fa fa-trash-o fa-fw text-danger"></i> حذف</a></li>
			<?php else: ?>
				<li><a href="?id=<?php echo $account->id; ?>&status=1"><i class="fa fa-undo fa-fw text-success"></i> نشط</a></li>
			<?php endif; ?>
		</ul> 
	</li>
	<li role="presentation" class="dropdown pull-right til-menu-right"> <a href="#" class="dropdown-toggle" id="myTabDrop1" data-toggle="dropdown" aria-controls="myTabDrop1-contents" aria-expanded="false"><i class="fa fa-print"></i><span class="hidden-xs"> طباعة</span><span class="caret"></span></a> 
		<ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents"> 
			<li><a href="print-statement.php?id=<?php echo $account->id; ?>&print" target="_blank"><i class="fa fa-file-text-o fa-fw"></i> طباعة كشف الحساب</a></li>
			<li class="divider"></li>
			<li><a href="print-barcode.php?id=<?php echo $account->id; ?>&print" target="_blank"><i class="fa fa-barcode fa-fw"></i> طباعة الباركود</a></li>
			<li><a href="print-address.php?id=<?php echo $account->id; ?>&print" target="_blank"><i class="fa fa-address-book-o fa-fw"></i> طباعة بطاقة العنوان</a></li>
			<li><a href="print-cargo.php?id=<?php echo $account->id; ?>&print" target="_blank"><i class="fa fa-address-book-o fa-fw"></i> طباعة الباركود البضائع</a></li>
		</ul> 
	</li>
</ul>
	...
	<div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab"> 
			...
			<div class="col-md-8">
				...
				<form name="form_add_accout" id="form_add_account" action="" method="POST" class="validate">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="text" name="code" id="code" value="<?php echo $account->code; ?>" class="form-control"  maxlength="32">
							</div> <!-- /.form-group -->

							<div class="form-group">
								<label for="name">اسم الحساب <sup class="text-muted">الاسم الشخصي، اللقب، اسم الشركة، اسم الشركة، الخ..</sup></label>
								<input type="text" name="name" id="name" value="<?php echo $account->name; ?>" class="form-control required"  maxlength="32">
							</div> <!-- /.form-group -->

							<div class="form-group">
								<label for="email">البريد الإلكتروني</label>
								<input type="email" name="email" id="email" value="<?php echo $account->email; ?>" class="form-control email"  maxlength="100">
							</div> <!-- /.form-group -->
							...
							<div class="row">
								<div class="col-xs-6 col-md-6">
									<div class="form-group">
										...
										<input type="tel" name="gsm" id="gsm" value="<?php echo $account->gsm; ?>" class="form-control required digits"  maxlength="100">
									</div> <!-- /.form-group -->
								</div> <!-- /.col -->
								<div class="col-xs-6 col-md-6">
									<div class="form-group">
										<label for="phone">الهاتف الثابت</label>
										<input type="tel" name="phone" id="phone" value="<?php echo $account->phone; ?>" class="form-control digits"  maxlength="100">
									</div> <!-- /.form-group -->
								</div> <!-- /.col -->
							</div> <!-- /.row -->
							...
							<div class="row">
								...
								<div class="col-xs-6 col-md-4">
									<div class="form-group">
										...
										<input type="tel" name="tax_no" id="tax_no" value="<?php echo $account->tax_no; ?>" class="form-control digits"  maxlength="20">
									</div> <!-- /.form-group -->
								</div> <!-- /.col -->
							</div> <!-- /.row -->
					...
					<div class="text-right">
						...
						<button class="btn btn-success btn-insert btn-xs-block"><i class="fa fa-floppy-o"></i> حفظ</button>
					</div>
			...
			<div class="col-md-4">
				...
				<div class="row space-none">
					<div class="col-md-5">
						...
						<div class="">
							<span class="ff-2 fs-17 bold <?php echo $account->balance < 0 ? 'text-danger' : 'text-success'; ?>"><?php echo get_set_money($account->balance); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
							<br />
				...
				<div class="row space-none">
					<div class="col-md-4">
						...
						<div class="">
							<span class="ff-2 fs-15 bold <?php echo $account->profit < 0 ? 'text-danger' : 'text-success'; ?>"><?php echo get_set_money($account->profit); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
							<br />
				...
				<div class="row">
					<div class="col-xs-6 col-md-6">
						<div class="">
							...
							<br />
							<span class="ff-2 fs-15 bold"><?php echo get_set_money($accountTotal['form_in']); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
						</div>
					</div> <!-- /.col -->
					<div class="col-xs-6 col-md-6">
						<div class="">
							...
							<br />
							<span class="ff-2 fs-15 bold"><?php echo get_set_money($accountTotal['form_out']); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
						</div>
					</div> <!-- /.col -->
				</div> <!-- /.row -->
				...
				<div class="row">
					<div class="col-xs-6 col-md-6">
						<div class="">
							...
							<br />
							<span class="ff-2 fs-15 bold"><?php echo get_set_money($accountTotal['payment_in']); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
						</div>
					</div> <!-- /.col -->
					<div class="col-xs-6 col-md-6">
						<div class="">
							...
							<br />
							<span class="ff-2 fs-15 bold"><?php echo get_set_money($accountTotal['payment_out']); ?></span> <small class="text-muted"><?php echo til()->company->currency; ?></small>
						</div>
					</div> <!-- /.col -->
				</div> <!-- /.row -->
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="h-20 visible-xs"></div>
				<small class="text-muted module-title-small"><i class="fa fa-pie-chart"></i> المنتجات الأكثر تفضيلا</small>
				<div class="h-10"></div>
						...
						<tr>
							...
							<td class="text-muted hidden-xs">
								...
								if($form->type=='form') {
									...
									if($form->in_out == '0') { echo 'إدخال الدفع'; } else { echo 'الدفع'; }	
								}
								?>
							</td>
							  <td class="text-muted hidden-xs">
